/* Lex.A · script.js */
(function(){
  var els=document.querySelectorAll('.section-h,.mchapter,.mcounter,.pitem,.lawyer,.doss,.sig,.office,.award');
  ...
  var co=new IntersectionObserver(function(entries){
    entries.forEach(function(e){
      ...
      (function s(t){
        ...
        if(p<1)requestAnimationFrame(s);else el.textContent=to.toLocaleString();
      })(start);
      co.unobserve(el);
    });
  },{threshold:0.4});
